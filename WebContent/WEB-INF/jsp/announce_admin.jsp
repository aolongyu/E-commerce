...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <form action="${pageContext.request.contextPath }/Findannounce.html" method="post">
            <div>
                <button type="submit" class="btn btn-default pull-right">查找公告</button>
            </div>
...
<c:forEach items="${announces}" var="announce">
                <tr>
                    <th scope="row"><a href="UserBShow.jsp?artNo=${announce.announId}">${announce.announId}</a></th>
                    <td>${announce.announTitle}</td>
                    <td>${announce.annountTime}</td>
                     <td>
                        <div role="presentation" class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="${pageContext.request.contextPath }/DeleteAnnounceId?announId=${announce.announId}">删除</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
