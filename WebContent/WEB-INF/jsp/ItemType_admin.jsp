    ...
    <div class="row">
        <div class="col-md-2">
            <div class="list-group">
                <a href="${pageContext.request.contextPath}/itemTypeAdd.html" class="list-group-item active">添加类型</a>
            </div>
        </div>
        <div class="col-md-10">
			...
			<form action="${pageContext.request.contextPath }/FindItemclass.html" method="post">
            <div>
                <button type="submit" class="btn btn-default pull-right">查找类型</button>
            </div>
            ...
            <table class="table">
                ...
                <tbody>
<c:forEach items="${itemClasses}" var="itemClasse">
                <tr>
                    <th scope="row"><a href="UserBShow.jsp?artNo=${itemClasse.itemId}">${itemClasse.itemId}</a></th>
                    <td>${itemClasse.itemType}</td>
                     <td>
                        <div role="presentation" class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="${pageContext.request.contextPath}/DeleteItemType?ItemTypeId=${itemClasse.itemId}">删除</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
