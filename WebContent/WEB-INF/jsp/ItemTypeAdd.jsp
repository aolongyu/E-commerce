		...
		<div class="row">
			<div class="col-md-2">
				<div class="list-group">
					<a href="${pageContext.request.contextPath}/addItem.html" class="list-group-item active">添加商品类型</a>
				</div>
			</div>
			<div class="col-md-10">
				...
				<form action="${pageContext.request.contextPath }/AddItemTypeAdd.html"
					method="post">

					<div class="form-group">
						<label for="title">商品类型名称</label> <input type="text" id="cname1"
							name="cname1" class="form-control" placeholder="商品类型名称" required>
					</div>
